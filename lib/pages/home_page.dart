...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: Drawer(
        child: Container(
          color: _selectedColor ?? AIMusicColor.primaryColor2,
          child: radios != null
              ? [
                  100.heightBox,
              ...
              .withGradient(
                LinearGradient(
                  colors: [
                    ...
                    _selectedColor ?? AIMusicColor.primaryColor1,
                  ],
                      ...
                      [
                        ...
                        Align(
                            ...
                            child: [
                              ...
                              10.heightBox,
                              "Chạm hai lần để phát".text.gray300.make(),
                            ].vStack())
                      ],
                    ))
                        .clip(Clip.antiAlias)
